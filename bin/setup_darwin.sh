...
# local PATH="${PATH}:${HOME}/Applications:/usr/X11/bin"
...
# in the login window
# TODO(jeff): Implement this; find a way of doing so without sudo access!
...
# Increase sound quality for Bluetooth headphones/headsets; this also resolves
# skipping audio output when sent over Jam Transit Headphones.
#
#     SEE ALSO
# 1. http://lifehacker.com/fix-your-bluetooth-audio-in-yosemite-with-this-terminal-1670380974
# 2. https://discussions.apple.com/thread/3200456?start=360&tstart=0
...
# Show mounted MacFuse / OSXFuse volumes on the desktop
# See also: https://github.com/osxfuse/osxfuse/wiki/FAQ#42-i-mounted-a-fuse-for-os-x-volume-but-i-do-not-see-a-volume-icon-on-the-desktop-why
...
# Set user home dir as the default location for new Finder windows
...
# Use column view
# Possible values: `Nlsv` (list), `icnv` (icon), `clmv` (column), `Flwv` (slide)
...
# Expand the following File Info panes: “General”, “Open with”, and
# “Sharing & Permissions"
...
sync_app_prefs "com.apple.finder"
...
# Default startup with CPU tab selected
# Integer range: 1 (CPU) .. 4 (Network)
...
# Disable smart quotes; they are anti-coder! Boo!
defaults write NSGlobalDomain NSAutomaticQuoteSubstitutionEnabled -bool false

# Disable smart dashes; they are anti-coder! Boo!
...
# Enable full keyboard access for all controls; i.e.: enable Tab in modal
# dialogs
...
# TODO(jeff): Implement this; it should be conditional based on the host that
# we are on, i.e.: on scorpio, we really want
# **/Volumes/Media/torrents/incomplete**, so we can add a step to the process
# below by creating a symbolic link going from the directory to the external
# media.
# Use `$HOME/Downloads/Incomplete` to store incomplete downloads
# INCOMPLETE_DOWNLOADS_DIR="${HOME}/Downloads/incomplete"
# mkdir -p "${INCOMPLETE_DOWNLOADS_DIR}"

defaults write org.m0k.transmission UseIncompleteDownloadFolder -bool true
defaults write org.m0k.transmission IncompleteDownloadFolder -string "${INCOMPLETE_DOWNLOADS_DIR}"
...
# Support for unsupported Network Volumes
defaults write com.apple.systempreferences TMShowUnsupportedNetworkVolumes 1


# Change Interval of Backups (1800 = 1800 seconds or 30 minutes)
...
# Disable local Time Machine snapshots: a) anti-friend of the small disk;
# b) anti-friend of the solid state disk
# TODO(jeff): Implement this; find a way of doing so without sudo access!
# sudo tmutil disablelocal

# Disable the sudden motion sensor as it is not useful for solid state disks
# sudo pmset -a sms 0

# Disable hibernation (speeds up entering sleep mode)
# sudo pmset -a hibernatemode 0

# TODO(jeff): Use this as part of the idea we had regarding a script that would
# conditionally automate doing this step along with optimizing the VM
# compression level. See notes at virgo.md for details!
